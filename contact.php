...
define("__TO__", "contacto@cellsius.cl");

//Success message
define('__SUCCESS_MESSAGE__', "Tu mensaje ha sido enviado. Te responderemos pronto. ¡Muchas gracias por contactarnos!");

//Error message
define('__ERROR_MESSAGE__', "error: tu mensaje no pudo enviarse. Por favor intentalo denuevo o contactanos al +56 9 99184756.");

//Messege when one or more fields are empty
define('__MESSAGE_EMPTY_FIELDS__', "Por favor llena todos los campos, esto nos permitirá entregarte un mejor servicio");
